    ...
    <main className="mx-auto max-w-3xl px-4 py-16 space-y-8">
      ...
      <footer className="pt-8 border-t border-foreground/5">
        <div className="flex items-center gap-4">
          <span className="text-sm text-muted/50">elsewhere</span>
          <div className="flex items-center gap-3">
            <a href="https://x.com/tarat_211" target="_blank" rel="noreferrer" aria-label="X" className="text-muted/40 hover:text-foreground transition-colors">
            ...
            <a href="https://www.linkedin.com/in/tarun-tomar-4ab0b5193/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="text-muted/40 hover:text-foreground transition-colors">
            ...
            <a href="https://www.instagram.com/tarat.hobbies/" target="_blank" rel="noreferrer" aria-label="Instagram" className="text-muted/40 hover:text-foreground transition-colors">
            ...
            <a href="https://github.com/TarunTomar122" target="_blank" rel="noreferrer" aria-label="GitHub" className="text-muted/40 hover:text-foreground transition-colors">
