        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://www.buymeacoffee.com/taratdev" target="_blank" rel="noreferrer" aria-label="Buy Me a Coffee" className="text-muted/40 hover:text-foreground transition-colors">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M5 3L4.35 6.34H17.94L16.5 15.53L9.65 17L4.42 15.44L3.77 18.22L9.65 20L17.42 18.08L19.32 6.34H20.65L21 4H5Z"/></svg>
            </a>
          </div>
        </div>
      </footer>
